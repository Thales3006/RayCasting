...
function colisao_entidade(movel,obj_lista){
    return obj_lista.findIndex((o) => colisao_area(movel, movel.larg, o, o.larg)&&!(o.x==movel.x&&movel.y==o.y) );
}
...
function colisao_ponto(movel,obj_lista){
    let num = obj_lista.findIndex((a) => (movel.x>=a.x&&movel.x<=a.x+1)&&(movel.y>=a.y&&movel.y<=a.y+1));
